...
GetEstimateQuotesData getEstimateQuotesDataFromJson(String str) => GetEstimateQuotesData.fromJson(json.decode(str));

String getEstimateQuotesDataToJson(GetEstimateQuotesData data) => json.encode(data.toJson());
...
class GetEstimateQuotesData {
  ...
  factory GetEstimateQuotesData.fromJson(Map<String, dynamic> json) => GetEstimateQuotesData(
    data: json["data"] == null ? [] : List<EstimateQuotesData>.from(json["data"]!.map((x) => EstimateQuotesData.fromJson(x))),
...
class EstimateQuotesData {
  ...
  factory EstimateQuotesData.fromJson(Map<String, dynamic> json) => EstimateQuotesData(
    eqId: json["eq_id"],
